...
const MAX_CHANNELS: usize = 63; // MAXIMUM_WAIT_OBJECTS (64) minus 1 for shutdown event
...
impl WindowsEventLogConfig {
    ...
    pub fn validate(&self) -> Result<(), crate::Error> {
        ...
        // WaitForMultipleObjects supports up to MAXIMUM_WAIT_OBJECTS (64) handles.
